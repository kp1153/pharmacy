    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <div className="bg-blue-700 px-4 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-white font-extrabold text-lg">📦 खरीद</h1>
        </div>
        <Link href="/dashboard/purchases/new" className="bg-white text-blue-700 font-bold text-sm px-3 py-1.5 rounded-lg">+ जोड़ो</Link>
      </div>
        ...
        <div className="overflow-x-auto rounded-xl shadow border border-gray-200 bg-white">
          <table className="w-full text-sm">
            <thead className="bg-gray-900 text-white">
              <tr>
                <th className="text-left px-4 py-3">वितरक</th>
                <th className="text-left px-4 py-3">इनवॉइस</th>
                <th className="text-right px-4 py-3">कुल</th>
