...
export default async function Dashboard() {
  ...
  const cards = [
    ...
    { label: "Patients", value: patCount.count, icon: "👤", href: "/dashboard/sales", color: "bg-green-50 border-green-200 text-green-700" },
    ...
    { label: "Near Expiry", value: expiryCount.count, icon: "⚠️", href: "/dashboard/alerts/expiry", color: "bg-red-50 border-red-200 text-red-700" },
    { label: "Low Stock", value: reorderCount.count, icon: "📉", href: "/dashboard/alerts/reorder", color: "bg-orange-50 border-orange-200 text-orange-700" },
  ...
  const quickLinks = [
    ...
    { label: "Credit", icon: "📒", href: "/dashboard/credit" },
  ];

  const moreLinks = [
    { label: "Narcotic Log", icon: "📋", href: "/dashboard/narcotic-log", color: "bg-orange-50 border border-orange-200 text-orange-700" },
    { label: "Bank", icon: "🏦", href: "/dashboard/bank-reconciliation", color: "bg-teal-50 border border-teal-200 text-teal-700" },
    { label: "GST Export", icon: "📊", href: "/dashboard/gst-export", color: "bg-indigo-50 border border-indigo-200 text-indigo-700" },
    { label: "Tally Export", icon: "📁", href: "/dashboard/tally-export", color: "bg-violet-50 border border-violet-200 text-violet-700" },
    { label: "Promise Orders", icon: "🕐", href: "/dashboard/promise-orders", color: "bg-amber-50 border border-amber-200 text-amber-700" },
  ];
